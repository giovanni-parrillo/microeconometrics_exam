...
\caption{Parallel Trends: Average Deforestation Rates}
...
In the figure below, we present the estimated $\delta_s$ coefficients, which are represented by the control group line, and the estimated combined effect of having an RTA with enviromental provisions, represented by the treatment group line.
